    ...
    <div className="pb-28">
      ...
      <div className="px-4">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="relative aspect-square overflow-hidden rounded-4xl bg-vt-light-blue"
        >
          <img src={product.image} alt={product.name} className="h-full w-full object-cover" />
          <button
            type="button"
            onClick={() => toggle(product)}
            className="absolute right-4 top-4 rounded-full bg-white p-3 shadow-card"
          >
            <Heart
        ...
        <div className="mt-5">
          ...
          {product.colors.length > 0 && (
            <div className="mt-6">
              <p className="mb-2 text-sm font-semibold text-vt-dark">Color</p>
                ...
                {product.colors.map((c) => (
                  <button
                    ...
                    className={cn(
                      ...
                      selectedColor === c.id ? 'ring-2 ring-vt-blue' : 'border-slate-200',
                    )}
          ...
          {product.sizes.length > 0 && (
            <div className="mt-5">
              <p className="mb-2 text-sm font-semibold text-vt-dark">Size</p>
